...
export const VaultPage = ({ vaultMeta, vaultAddress }: VaultPageProps) => {
  ...
  return (
    <div>
      <section className="flex flex-col items-center justify-center py-4 border border-gray-200 pb-4 ">
        <h2 className="text-2xl font-semibold font-mono ">Total Assets</h2>
      ...
      <section className="flex flex-col md:grid md:grid-cols-2 gap-4 pt-4">
        <div className="border border-gray-100 py-4 flex flex-col items-center justify-center">
            <h2 className="text-lg font-semibold pb-4 ">Deposit</h2>
            <div className="flex flex-row gap-2 items-center w-full px-4">
            <TextInput
              value={depositAmount}
